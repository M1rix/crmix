...
import uz.mirix.crmix.messaging.application.SupportService;
...
public class TelegramWebhookController {
    ...
    void webhook(
        ...
        if (text.equals("/support") || text.startsWith("/support ")) {
            supportService.submit(chatId, text.length() <= 8 ? "" : text.substring(8));
        }
    }
